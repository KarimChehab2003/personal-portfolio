...
export const techStack: Tech[] = [
  { label: "Next.js", icon: SiNextdotjs, color: "#333333" },
...
export const workExperience: Work[] = [
  {
    ...
    description: [
      "Developing responsive React components with TailwindCSS.",
      "Implementing UI improvements and bug fixes.",
      "Collaborating remotely on focused deliverables.",
    ],
  },
  {
    ...
    date: "May 2025",
    description: [
      "Built and deployed three projects: an e-commerce platform, authentication system, and payment gateway integration using mock/test APIs.",
    ],
  },
];
...
export const projects: ProjectItem[] = [
  {
    ...
    image: eCommerceNextjsImage,
    technologies: ["Next.js", "React", "Typescript", "TailwindCSS", "Zustand"],
    codeUrl: "https://github.com/KarimChehab2003/e-commerce-nextjs",
    liveDemoUrl: "https://e-commerce-nextjs-karim-chehab.vercel.app/",
  },
  {
  ...
  },
  {
    ...
    description:
      "Allows users to efficiently manage products, track stock levels, and perform CRUD operations with real-time updates.",
  ...
  },
  {
    ...
    description:
      "Responsive company website built to improve brand visibility and user experience",
  ...
  },
  {
    title: "ShopEase",
    description:
      "A sleek and responsive e-commerce that allows users to browse products, add items to a shopping cart, and proceed to checkout.",
    image: shopEaseImage,
    technologies: ["React", "Javascript", "TailwindCSS"],
    codeUrl:
      "https://github.com/KarimChehab2003/E-commerce-website-UneeqIntern",
    liveDemoUrl:
      "https://karimchehab2003.github.io/E-commerce-website-UneeqIntern/",
  },
  {
    title: "React Query Practice Projects",
    description:
      "A modular React project comprising 6 apps, each focusing on a core React Query pattern.",
    ...
    liveDemoUrl:
      "https://karimchehab2003.github.io/react-query-projects/#/feedback-board",
  },
];
